...
$date=date('Y-m-d');
 foreach($item as $row)
 {
    echo "<tr>";
     ...
     echo "<td style='background-color:#cff01a7a'>".'<a class="btn btn-info" href="admin_feedback_delete?id=' . $row['id'] . '">Delete' . '</a>'."</td>";
   }
 else
     {
      echo "<td>" . $row['id'] . "</td>";
     ...
     echo "<td>" . $row['date'] . "</td>";
     echo "<td>" . $row['time'] . "</td>";
     echo "<td>".'<a class="btn btn-info" href="admin_feedback_delete?id=' . $row['id'] . '">Delete' . '</a>'."</td>";
   }
  echo "</tr>";
}
 //echo $count;
